...
$afterpay_sdk_env_config = [
    ...
    'countryCode' => 'US',
    'apiEnvironment' => 'sandbox', // must be 'stage', 'sandbox' or 'production'
    'customApiEnvironmentUrl' => '', // required if not using 'sandbox' or 'production'
    'customMerchantPortalFqdn' => '', // required if not using 'sandbox' or 'production'
